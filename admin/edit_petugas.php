...
include "session.php";
$id=$_GET['id'];
$data=mysql_fetch_array(mysql_query("SELECT * FROM petugas WHERE id_petugas='$id'"));
?>
<!DOCTYPE html>
<html lang="en" >
...
<form action="aksi_edit_petugas.php" method="POST">
  <div class="form-group">
    <label >ID petugas</label>
    <input type="text" class="form-control" name="id" value="<?php echo $data['id_petugas'];?>" style="display: none;">
    <input type="text" class="form-control" name="id" value="<?php echo $data['id_petugas'];?>" disabled>
  </div>
  <div class="form-group">
    <label >Nama Petugas</label>
    <input type="text" class="form-control" name="nama" placeholder="Nama Petugas" value="<?php echo $data['nama_petugas'];?>">
  </div>
   <div class="form-group">
    <label >Username Petugas</label>
    <input type="text" class="form-control" name="user" placeholder="Username Petugas" value="<?php echo $data['username'];?>">
  </div>
   <div class="form-group">
    <label >Password Petugas</label>
    <input type="text" class="form-control" name="pass" placeholder="Password Petugas" value="<?php echo $data['password'];?>">
  </div>
  <div class="form-group">
 ...
 <?php } ?>
  ...
  <button type="submit" class="btn btn-default" name="save">Simpan</button>
</form>
</div>
</div>
  <!-- Footer -->
