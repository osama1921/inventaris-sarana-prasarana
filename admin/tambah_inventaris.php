...
<form action="aksi_tambah_inventaris.php" method="POST">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label >Kondisi</label>
    <input type="text" class="form-control" name="kon" placeholder="Kondisi">
  </div>
   <div class="form-group">
  ...
  <?php 
  $qjenis=mysql_query("SELECT * FROM jenis");
  while ($djenis=mysql_fetch_array($qjenis)) { ?>
    <option value="<?php echo $djenis['id_jenis'];?>"><?php echo $djenis['nama_jenis'];?></option>
  <?php } ?>
    < </select>
  </div>
       <div class="form-group">
  ...
  <?php } ?>
    ...
    <input type="text" class="form-control" name="kode" placeholder="Kode Inventaris ">
  </div>
  <div class="form-group">
  <label>petugas</label>
  <select name="petugas" class="form-control">
  <?php 
  $qpetugas=mysql_query("SELECT * FROM petugas");
  while ($dpetugas=mysql_fetch_array($qpetugas)) { ?>
    <option value="<?php echo $dpetugas['id_petugas'];?>"><?php echo $dpetugas['nama_petugas'];?></option>
  <?php } ?>
    < </select>
  </div>
    <div class="form-group">
...
<option>Tidak Sekali Pakai</option>
     </select>
  </div>
