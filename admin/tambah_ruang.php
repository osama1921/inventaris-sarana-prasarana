...
<form action="aksi_tambah_ruang.php" method="POST">
  <div class="form-group">
    <label>Nama Ruang</label>
  
      <input type="text" class="form-control" name="nama" placeholder="Nama Ruang..">
  
  </div>
  <div class="form-group">
    <label>Kode Ruang</label>
      <input type="text" class="form-control" name="kode" placeholder="Kode Ruang">
  </div>
   <div class="form-group">
