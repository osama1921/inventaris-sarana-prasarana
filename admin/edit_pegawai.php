...
include "session.php";
$idd=$_GET['id'];
$data=mysql_fetch_array(mysql_query("SELECT * FROM pegawai WHERE id_pegawai='$idd'"));
?>
<!DOCTYPE html>
<html lang="en" >
...
<form action="aksi_edit_pegawai.php" method="POST">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="nip" value="<?php echo $data['NIP'];?>" placeholder="Nama Pegawai">
  </div>
  <div class="form-group">
    <label >Nama Pegawai</label>
    <input type="text" class="form-control" name="nama" value="<?php echo $data['nama_pegawai'];?>" placeholder="Nama pegawai">
  </div>
   <div class="form-group">
    <label >Username Pegawai</label>
    <input type="text" class="form-control" name="user" value="<?php echo $data['username'];?>" placeholder="Username pegawai">
  </div>
   <div class="form-group">
    <label >Password Pegawai</label>
    <input type="text" class="form-control" name="pass" value="<?php echo $data['password'];?>" placeholder="Password Pegawai">
  </div>
  <div class="form-group">
    <label>Alamat</label>
    <textarea class="form-control" name="alt"> <?php echo $data['alamat'];?></textarea>
  </div>
