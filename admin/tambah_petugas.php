...
<form action="aksi_tambah_petugas.php" method="POST">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="user" placeholder="Username Petugas">
  </div>
   <div class="form-group">
    <label >Password Petugas</label>
    <input type="text" class="form-control" name="pass" placeholder="Password Petugas">
  </div>
  <div class="form-group">
