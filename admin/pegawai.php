...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5 style="font-size: 18px;"><b><i class="fa fa-arrow-right"></i> Data Pegawai</b></h5>
  </header>
  <div class="w3-container">
<a href="tambah_pegawai.php"><button class="btn btn-success fa fa-pencil"> Tambah Data Pegawai</button></a>
 </div>
  </div>

<div class="w3-container w3-padding w3-main" style="margin-left:300px;margin-top:43px;">
<div class="table-responsive">
<table class="table  table-striped table-bordered table-hover" id="table_pegawai">
  <thead>
    <th>No</th>
    <th>NIP</th>
    <th>Nama Pegawai</th>
  ...
  <tbody>
    ...
    while ($data=mysql_fetch_array($query)) { ?>
      ...
      <td><a href="edit_pegawai.php?id=<?php echo $data['id_pegawai'];?>"><button class="btn btn-success"><i class="fa fa-pencil-square-o"></i></button></a>
      <a href="hapus_pegawai.php?id=<?php echo $data['id_pegawai'];?>"><button class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Mau Menghapus Data ini?');"><i class="fa fa-trash"></i></button></a></td>
      </tr>
   <?php }
   ?>
  </tbody>
