...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5 style="font-size: 18px"><b><i class="fa fa-building-o"></i> Data Ruang</b></h5>
  </header>
  <div class="w3-container">
<a href="tambah_ruang.php"><button class="btn btn-success fa fa-pencil"> Tambah Data Ruang</button></a>
 </div>
  </div>
  ...
  <tbody>
    ...
    while ($data=mysql_fetch_array($query)) { ?>
      <tr>
        ...
        <td><a href="edit_ruang.php?id=<?php echo $data['id_ruang'];?>"><button class="btn btn-success"><i class="fa fa-pencil-square-o"></i></button></a>
        <a href="hapus_ruang.php?id=<?php echo $data['id_ruang'];?>"><button class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Mau Menghapus Data Ini?');"><i class="fa fa-trash"></i></button></a></td>
      </tr>
   <?php }
   ?>
  </tbody>
