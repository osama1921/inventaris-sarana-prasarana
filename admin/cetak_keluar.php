...
<page>
<div style="font-size: 25px; text-align: center; text-transform: uppercase; font-weight: 3px; margin-bottom: 20px">Laporan Inventaris Keluar Sekolah</div>
...
<tr>
    ...
    <th style="text-align: center; padding:8px 4px; ">Tanggal Keluar</th>
    ...
    <th style="text-align: center; padding:8px 4px; ">Pegawai</th>
    <th style="text-align: center; padding:8px 4px; ">Keterangan</th>
</tr>

';
$no=1;
    $query=mysql_query("SELECT * FROM inventaris_keluar");
...
<tr>
    ...
    <td style="height:30px">'.$data['tanggal_keluar'].'</td>
    ...
    <td style="height:30px; text-align:center;">'.$datapegawai['nama_pegawai'].'</td>
...
$html2pdf->Output('Laporan Inventaris Keluar.pdf');
?>
