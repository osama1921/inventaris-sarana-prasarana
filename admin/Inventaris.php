...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5 style="font-size: 18px;"><b><i class="fa fa-arrow-right"></i> Data Inventaris</b></h5>
  </header>
  <div class="w3-container">
<a href="tambah_inventaris.php"><button class="btn btn-success fa fa-pencil"> Tambah Data Inventaris</button></a>
 </div>
  </div>
  ...
  <tbody>
    ...
    while ($data=mysql_fetch_array($query)) { ?>
      <tr>
        ...
        ?></td>
        <td><?php $id_petugas=$data['id_petugas'];
        $dpetugas=mysql_fetch_array(mysql_query("SELECT * FROM petugas WHERE id_petugas='$id_petugas'"));
        echo $dpetugas['nama_petugas'];
        ?></td>
        <td><?php echo $data['keterangan'];?></td>
        <td><?php echo $data['status'];?></td>
      <td><a href="hapus_inventaris.php?id=<?php echo $data['id_inventaris'];?>"><button class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin Mau Menghapus Data Ini?');"><i class="fa fa-trash"></i></button></a></td>
      </tr>
   <?php }
   ?>
  </tbody>
