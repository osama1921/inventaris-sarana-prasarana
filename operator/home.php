...
include 'session.php';
$data=mysql_fetch_array(mysql_query("SELECT * FROM petugas WHERE id_petugas='".$_SESSION['idpetugas']."'"));
?>
<!DOCTYPE html>
<html lang="en" >
...
<div class="panel panel-info">
  ...
  <div class="panel-body">
    <p style=" font-size: 30px; color: #0eaf6c!important">Selamat Datang <?php echo $data['nama_petugas'];?></p>
